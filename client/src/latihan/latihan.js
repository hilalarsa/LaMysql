...
import KerjakanLatihanButton from './kerjakanLatihanButton';
...
export const listLatihan = (props, { record }) => (
    <List {...props} title="Latihan">
        <Datagrid>
            <TextField source="id" />
            <TextField source="text_soal" />
            <KerjakanLatihanButton />
        </Datagrid>
    </List>
);
